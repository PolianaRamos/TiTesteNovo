...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest3
    {
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            .List("Cat1").Model).PagingInfo.TotalItens;
            int res2 = ((ProductsListViewModel)target
            .List("Cat2").Model).PagingInfo.TotalItens;
            int res3 = ((ProductsListViewModel)target
            .List("Cat3").Model).PagingInfo.TotalItens;
            int resAll = ((ProductsListViewModel)target
            .List(null).Model).PagingInfo.TotalItens;
            // Assert
        ...
        {
            Mock<IProductRepository> mock = new Mock<IProductRepository>();
            mock.Setup(m => m.Usuario).Returns(new Usuario[] {
            new Usuario {Nome_Usuario = "João da Silva", Senha = "senhasegura"} });


            LoginController loginController = new LoginController();
            loginController.Entrar(mock.Object);

            Assert.AreEqual(null,loginController);
